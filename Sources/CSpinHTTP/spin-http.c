...
WASM_EXPORT("spin-http", "handle-http-request")
int32_t __wasm_export_spin_http_handle_http_request(int32_t arg, int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8) {
  // HACK: Calling _start here will execute top-level swift code. Eventually this
  //       should move to the runtime, but currently needs to live in the library.
  _start();
